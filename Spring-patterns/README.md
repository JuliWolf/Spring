...
+ [Dependency injection как лучше писать и почему](#dependency-injection-как-лучше-писать-и-почему)
+ [Свои аннотации](#свои-аннотации)
+ [Chain of responsibility](#chain-of-responsibility)
+ [Как заинджектить свой лист, кастомный лист](#как-заинджектить-свой-лист-кастомный-лист)
+ [Заменить старые аннотации на новые](#заменить-старые-аннотации-на-новые)
+ [Стратегия и Комманда (Strategy & Command)](#стратегия-и-комманда-strategy--command)
+ [Как в runtime регистрировать бины](#как-в-runtime-регистрировать-бины)
+ [Динамический pointcut](#динамический-pointcut)
+ [Добавить обертку для ответа](#добавить-обертку-для-ответа)
...
+ [Избавляемся от switch](#избавляемся-от-switch)
